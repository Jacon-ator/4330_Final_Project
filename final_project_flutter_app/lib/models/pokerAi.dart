...
class PokerAI {
  ...
  final double _callThreshold = 0.4;    // Call if probability is between fold and call thresholds
  final double _raiseThreshold = 0.7;   // Raise if probability is between call and raise thresholds
  final double _allInThreshold = 0.85;  // All-in if probability is above this threshold
  ...
  int calculateBetAmount(double winProbability, int currentBet, int playerBalance) {
