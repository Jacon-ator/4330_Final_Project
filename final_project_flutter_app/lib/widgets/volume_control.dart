                  ...
                  builder: (context, muteSnapshot) {
                    ...
                    return StreamBuilder<double>(
                      ...
                      builder: (context, volumeSnapshot) {
                        ...
                        final displayValue = isMuted ? 0.0 : (volumeSnapshot.data ?? 1.0);
                        ...
                        return SliderTheme(
                          data: SliderThemeData(
                            ...
                            activeTrackColor: const Color(0xFF468232), // Green color matching the app theme
                ...
                builder: (context, volumeSnapshot) {
                  ...
                  return Container(
                    ...
                    child: IconButton(
                      icon: Icon(
                        volumeIcon,
                        color: const Color(0xFF468232), // Green color matching the app theme
                      ),
                      onPressed: () {
