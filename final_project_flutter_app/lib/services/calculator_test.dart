...
void testProbabilityPocketPairVsOvercards() {
  ...
  print('Expected outcome: Nearly 50/50 chance, with pocket pair slight favorite');
  print('--------------------------------------------------------------');
  ...
  print('Calculation completed in $executionTime ms');
  print('RESULT: Win probability for pocket 88 vs random hand: ${(probability * 100).toStringAsFixed(2)}%');
  print('Interpretation: Small-medium pocket pairs are favorites against random hands');
