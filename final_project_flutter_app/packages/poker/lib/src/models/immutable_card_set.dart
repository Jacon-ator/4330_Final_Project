...
class ImmutableCardSet with IterableMixin<Card> {
  ...
  int get length {
    ...
    v = v - ((v >> 1) & 0x5555555555555400);  // Modified for JavaScript compatibility
    v = (v & 0x3333333333333400) + ((v >> 2) & 0x3333333333333400);  // Modified for JavaScript compatibility
    v = (v + (v >> 4)) & 0xf0f0f0f0f0f0f00;  // Modified for JavaScript compatibility
    v = v + (v >> 8);
    v = v + (v >> 16);
    v = v + (v >> 32);
